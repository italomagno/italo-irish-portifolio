...
export default async function BlogPost({ params, }: { params: Promise<{ slug: string }> }) {
    ...
    const prevPost = currentPostIndex > 0 ? blogData.posts[currentPostIndex - 1] : null;
    const nextPost = currentPostIndex < blogData.posts.length - 1 ? blogData.posts[currentPostIndex + 1] : null;
            ...
            <div className="container mx-auto max-w-[1320px] px-5 md:px-10 xl:px-5">
                <div className="py-24 xl:py-28">
                    <div className="md:mx-auto md:w-3/4 lg:w-2/3">
                        <h2 className="font-outfit font-medium text-4xl md:text-5xl lg:text-6xl text-white mb-4">{post.title.replace(lastWord, '')} <span className="bg-themeGradient bg-clip-text text-transparent">{lastWord}</span></h2>
                ...
                <div className="bg-darkBg rounded-2xl overflow-hidden py-20">
                    <div className="container mx-auto max-w-[1320px] px-5">
                        ...
                        <div className="mt-6 lg:mt-12">
                            <Image className="rounded-lg" src={post.wideImage} alt={post.title} loading="lazy" placeholder="blur" />
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12 mt-6 lg:mt-12">
                            ...
                            {post.imagesLightbox && (
                                <div className="overflow-hidden rounded-lg">
                                    <a href={post.imagesLightbox.image.src} className="glightbox group block relative before:content-[''] before:z-[1] before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-themeGradient before:opacity-0 hover:before:opacity-10 before:transition-all before:ease-linear before:duration-100">
                                        <Image src={post.imagesLightbox.image} alt={post.imagesLightbox.alt} loading="lazy" placeholder="blur" width={1280} height={500} className="group-hover:scale-105 transition ease-custom duration-500" />
                            ...
                            {post.video && (
                                <div className="overflow-hidden rounded-lg">
                                    <a href={post.video.url} data-gallery="video" className="glightbox group block relative before:content-[''] before:z-[1] before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-themeGradient before:opacity-0 hover:before:opacity-10 before:transition-all before:ease-linear before:duration-100">
                                        <Image src={post.video.thumbnail} alt={post.title} loading="lazy" placeholder="blur" width={1280} height={500} className="group-hover:scale-105 transition ease-custom duration-500" />
                        ...
                        <div className="flex justify-between mt-12">
                            ...
                            {nextPost ? (
                                <Link
                                    ...
                                    className="inline-block relative z-[1] group overflow-hidden bg-white/15 px-7 py-3 rounded-3xl font-outfit font-medium uppercase text-sm tracking-wider text-white before:content-[''] before:absolute before:-z-[1] before:left-0 before:top-0 before:w-full before:h-full before:bg-themeGradient before:opacity-0 hover:before:opacity-20 before:transition-all before:ease-linear before:duration-100"
                                >
                                    <span className="block relative text-transparent before:content-[attr(data-text)] before:absolute before:top-0 before:left-0 before:opacity-100 before:text-white before:transition-all before:ease-out before:duration-200 group-hover:before:-top-full group-hover:before:opacity-0 after:content-[attr(data-text)] after:absolute after:top-full after:left-0 after:opacity-0 after:text-white after:transition-all after:ease-out after:duration-200 group-hover:after:top-0 group-hover:after:opacity-100" data-text="Next Post">Next Post</span>
                                </Link>
                            ) : (
                                <div className="opacity-50 pointer-events-none inline-block relative z-[1] group overflow-hidden bg-white/15 px-7 py-3 rounded-3xl font-outfit font-medium uppercase text-sm tracking-wider text-white before:content-[''] before:absolute before:-z-[1] before:left-0 before:top-0 before:w-full before:h-full before:bg-themeGradient before:opacity-0 hover:before:opacity-20 before:transition-all before:ease-linear before:duration-100">
                                    <span className="block relative text-transparent before:content-[attr(data-text)] before:absolute before:top-0 before:left-0 before:opacity-100 before:text-white before:transition-all before:ease-out before:duration-200 group-hover:before:-top-full group-hover:before:opacity-0 after:content-[attr(data-text)] after:absolute after:top-full after:left-0 after:opacity-0 after:text-white after:transition-all after:ease-out after:duration-200 group-hover:after:top-0 group-hover:after:opacity-100" data-text="No Next Post">No Next Post</span>
                                </div>
                            )}
                        </div>
                    </div>
