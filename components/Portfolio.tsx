            ...
            <div className="bg-darkBg rounded-2xl overflow-hidden py-20">
                <div className="container mx-auto max-w-[1320px] px-5">
                    <div className="md:w-4/5 lg:w-3/4 md:mx-auto">
                        <h6 className="pl-[20px] relative font-outfit font-medium text-sm uppercase tracking-wider text-white/40 before:content-[''] before:absolute before:left-0 before:top-1/2 before:-translate-y-1/2 before:w-[12px] before:h-[12px] before:rounded-full before:border-2 before:border-white/30">{portfolioData.mainData.title}</h6>
                        <h2 className="font-outfit font-medium text-4xl md:text-5xl lg:text-6xl text-white mt-2">{portfolioData.mainData.title2} <span className="bg-themeGradient bg-clip-text text-transparent">{portfolioData.mainData.title2Span}</span></h2>
                        <p className="leading-[1.75] text-white/70 mt-3">{portfolioData.mainData.description}</p>
                        {/* Slider Nav */}
                            ...
                            <SwiperSlide key={idx}>
                                <div className="group/portfolio-box">
                                    ...
                                    <div className="overflow-hidden relative rounded-2xl">
                                        ...
                                        >
                                            <Image src={project.mainImage} alt={project.title} placeholder="blur" className="group-hover:scale-105 transition ease-custom duration-500" />
                                        </Link>
                                    </div>
                                    <div className="pt-6">
                                        {/* Categories */}
